...
public class animes implements Comparable<animes>{
    ...
    public animes(String mal_id, String title, String rating, String popularity, String status, String synopsis, String airing, String image, String season, String year) {
        this.title = title;
        this.rating = rating;
    ...
    public int compareTo(animes animes) {
        ...
        if (Integer.parseInt(animes.getPopularity() ) < Integer.parseInt(popularity)) {
            return -1;
